...
// import honeypot from '../assets/honeypot.svg';
// import bear from '../assets/bear.svg';
// import Footer from './Footer';
// import ValidatorScoring from './stakecomponents.jsx/ValidatorScoring';
...
//           <img src={honeypot} alt="Honeypot Background" className="w-full h-[2500px] object-cover" />
//         </div>
...
//           className="absolute left-0 w-full -z-10"
//           style={{
//             top: '2445px', // Start the background color just below the honeypot image
//             backgroundColor: '#E2C7BB',
//             height: `${bgHeight-1700}px`, // Dynamically extend with validators
//           }}
//         ></div>
