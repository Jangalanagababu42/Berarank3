      ...
      <div className="grid grid-cols-12 items-center space-x-[95px]">
        ...
        <div className="col-start-6 col-span-7  flex  justify-between items-center  h-[53px] space-x-12">
          <div className="flex w-[279px] h-[44px] space-x-[30px] items-center font-poppins font-medium text-base">
            ...
            <a
              href="#"
              className=" relative group text-black px-[10px] py-[10px] hover:bg-gradient-to-br from-grad-blue from-0% to-main-blue to-100% hover:text-white hover:px-[10px] hover:py-[5px] hover:rounded-[10px] hover:ring-1 ring-offset ring-main-blue"
            >
             <span class="block group-hover:hidden">Pools</span>
  <span class="hidden group-hover:block text-sm">coming soon</span>
            </a>
            <a
              href="#"
              className="relative group text-black px-[10px] py-[10px] hover:bg-gradient-to-br from-grad-blue from-0% to-main-blue to-100% hover:text-white hover:px-[10px] hover:py-[5px] hover:rounded-[10px] hover:ring-1 ring-offset ring-main-blue"
